...
description: React Hook을 사용할때 지켜야하는 규칙은 무엇인지 그리고, 잘못 사용했을 때 어떠한 문제가 있는지 알아보도록 하겠습니다.
category: react
...
React 개발을 하다보면 종종 다음과 같은 오류들을 만날 수가 있습니다.
...
```tsx
function TimeComponent(props: { time?: Date; render: (date?: any) => JSX.Element }) {
