...
<div style={{ border: "solid 1px" }}>![call-component](./call-component.png "title")</div>

_React-Dev tools : Component 호출_

<div style={{ border: "solid 1px" }}>![call-function](./call-function.png)</div>

_React-Dev tools : Function 호출_
...
_예상치 못하게 hook이 더 사용되서 발생하는 오류_
