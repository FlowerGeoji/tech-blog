...
<div style={{ border: "solid 1px", marginBottom: "2rem" }}>![suspense-sample](./suspense-sample1.gif)</div>
...
<div style={{border: "solid 1px", marginBottom: "2rem"}}>

<img src="./synchronizing-log.png" alt="synchronizing-sample" />

<span style={{ display: "block", textAlign: "center", fontWeight: "bold", color: "#666666", fontSize: "0.9rem" }}>
    [fetchTodos는 fetchUser와 User렌더링 작업이 끝나야만 진행됨]
</span>
